...
echo "[$(date --iso-8601=seconds)] Starting zero-initialized 6-channel surface-normal fusion FP32 batch-32 smoke test"
...
OUTPUTS=(
    /home/alex/Development/Models/dex3/c_normals_6ch_early_fusion_patch_tuned_normals_init_zero_fp32_batch_32_acc_1_smoke_retry1_1708_2_test
)
