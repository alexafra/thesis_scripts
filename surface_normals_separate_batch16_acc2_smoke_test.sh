...
LOG=/home/alex/Development/surface_normals_separate_batch16_acc2_smoke_1608_1.log
STATUS=/home/alex/Development/surface_normals_separate_batch16_acc2_smoke_1608_1_status.tsv

exec >>"$LOG" 2>&1
printf 'model\tstatus\texit_code\n' > "$STATUS"
echo "[$(date --iso-8601=seconds)] Starting separate-normal BF16 batch-16 accumulation-2 smoke test"
